...
#'
#' `render_timevis()` saves the widget with a fixed width (1400, the approximate width of my laptop
#'   screen) and returns an `htmlwidgets` object without a specified width.
#'
